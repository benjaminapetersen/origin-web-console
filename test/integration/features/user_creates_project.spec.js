...
let createFromSource = (projectName, builderImageName, appName) => {
  ...
  h.waitForUri(uri);
  expect(element(by.css('#container-main .osc-form h1')).getText()).toEqual(builderImageName);
...
let createFromTemplate = (projectName, templateName, parameterNames, labelNames) => {
  ...
  h.waitForUri(uri);
  expect(element(by.css('#container-main .osc-form h1')).getText()).toEqual(templateName);
...
let checkProjectSettings = (projectName, displayName, description) => {
  ...
  h.goToPage(uri);
  expect(element(by.css('#container-main h1')).getText()).toEqual("Edit Project " + projectName);
    ...
    describe('new project', () => {
      ...
      describe('when creating a new project', () => {
        ...
        it('should browse builds', () => {
          ...
          h.waitForPresence('#container-main h1', 'Builds');
        ...
        it('should browse services', () => {
          ...
          h.waitForPresence("#container-main h1", "Services");
